...
/**
 * <p>
 *   Defines an expression to module two or more expressions.
 * </p>
 * 
 * 
 *  Java Page Templates
 ...
 */
public class ModExpression extends ArithmethicExpression {

	private static final long serialVersionUID = -1544731404628486525L;
	...
	static public ModExpression generate( String exp ) throws ExpressionSyntaxException {
		
		ModExpression result = new ModExpression();
		
		configure(
				exp,
				result,
				NAME,
				TwoPhasesPageTemplate.EXPR_MOD );
